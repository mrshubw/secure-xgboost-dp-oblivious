...
def predict_all(dataset, max_depth_list, num_rounds_list, data_size_list):
    ...
    for data_size in data_size_list:
        ...
        # import sys
        # if len(sys.argv) > 1:
        #     print("User number:", sys.argv[1])
        # enc_test_data = os.path.join(data_dir, f"datauser{sys.argv[1]}.enc")
...
if __name__ == "__main__":
    ...
    predict_all(dataset="higgs", max_depth_list=[9], num_rounds_list=[5], data_size_list=[10000])
    # predict_all(dataset="higgs", max_depth_list=[8], num_rounds_list=[5], data_size_list=[1])