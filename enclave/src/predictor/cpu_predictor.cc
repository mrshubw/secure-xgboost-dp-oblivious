...
#ifdef __ENCLAVE_DPOBLIVIOUS__
      xgboost::doxie::InferenceContext doxie_context;
      doxie_context.metrics = &prediction_metrics_;
      doxie_context.monitor = &monitor_;
      doxie_context.thread_temp = &thread_temp_;
      doxie_context.lock = &lock_;
      xgboost::doxie::PredictDMatrix(dmat, &out_preds->HostVector(), model,
