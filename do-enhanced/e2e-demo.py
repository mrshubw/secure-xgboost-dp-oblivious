...
training_data = HOME_DIR + "do-enhanced/data/demo/agaricus10.txt.train"
enc_training_data = CURRENT_DIR + "data/demo/train.enc"

# Encrypt training data
xgb.encrypt_file(training_data, enc_training_data, KEY_FILE)

test_data = HOME_DIR + "do-enhanced/data/demo/agaricus.txt.test"
enc_test_data = CURRENT_DIR + "data/demo/test.enc"
...
# for test_file in ['agaricus10.txt.test']:
    print("="*50)
    test_data = HOME_DIR + "do-enhanced/data/demo/" + test_file
